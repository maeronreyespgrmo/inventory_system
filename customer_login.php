...
<div class="header">
    ...
    <div class="container">
        ...
        <p class="login-text" style="font-size: 2rem; font-weight: 800; color:#333 ">Login</p>
			...
			<div class="user">
				<input type="email" placeholder="Email" name="email" value="<?php echo $email; ?>" required style= "width:250px;">
			</div>
			<div class="password">
				<input type="password" placeholder="Password" name="password" value="<?php echo $_POST['password']; ?>" required style= "width:250px;">
			</div>
			<div class="sub">
