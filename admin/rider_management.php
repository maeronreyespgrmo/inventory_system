...
<script>
    ...
    if (confirmResult) {
        // Redirect to delete_admin.php with the id parameter
        window.location.href = 'delete-contractor.php?id=' + id;
    } else {
...
<div class="main-content">
    <div class="wrapper">
        ...
        <form action="../admin/contractor-registration.php">
				<button name="submit" class="btn-primary1"> Contractor Registration</button>
                </form>
    ...
    while($row=mysqli_fetch_assoc($res))
    {
        ...
        ?>
            ...
            <tr>
                ...
                <td>
                <a href="#" onclick="confirmDelete(<?php echo $id; ?>)" class="delbutton" style="padding: 1%;">Delete</a>
                </td>
            </tr>
